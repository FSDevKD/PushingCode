...
function isValidWalk(walk) {
    // how long is walk 
    if(walk.length !== 10){  // measures the length
        return false; // false walk is too long
    }

    // how many steps in each direction set at 0 to record
    let n = 0,
        s = 0,
        w = 0, 
        e = 0, 

    // start loop to record walk and create switch for letter clicks
